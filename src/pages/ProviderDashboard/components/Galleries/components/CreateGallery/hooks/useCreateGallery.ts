...
import { useCreateGallery as useCreateGalleryMutation } from "../../../../../../../api/hooks/mutations";
...
export const useCreateGallery = (gridRef: RefObject<AgGridReact<any>>) => {
  ...
  const onCreateGallery = async () => {
    ...
    try {
      ...
      successControl(CREATE_GALLERY_MESSAGE, onCloseModal);
